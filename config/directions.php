...
| Тексты описаний — по материалам клиента (июнь 2026). Фото — заглушки Unsplash,
| заменить на фото студии, когда клиент пришлёт.
*/
...
return [
    'items' => [
        ...
        $dir([
            ...
            'num' => '10',
            'title' => 'Табата',
            'lead' => 'Интенсивная тренировка (интервальная физическая нагрузка). Система «Табата йоги» помогает избавиться от лишнего веса за короткий срок и сохранить долгосрочный эффект.',
