...
| Названия — по списку клиента (16 направлений). Описания — по материалам клиента.
| Фото — заглушки Unsplash, заменить на фото студии, когда клиент пришлёт.
*/
...
return [
    'items' => [
        ...
        $dir([
            ...
            'img' => 'photo-1767611133656-80a871fff5d4',
        ]),
        ...
        $dir([
            ...
            'num' => '15',
            'title' => 'Stic mobility',
            'lead' => 'Stic mobility — это практика, в которой используются специальные стики для улучшения мобильности, стабильности, силы и растяжки. Практика сочетает в себе улучшение мобильности суставов, развитие силы и активные растягивания.',
