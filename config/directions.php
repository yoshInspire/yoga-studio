...
| Направления студии
|--------------------------------------------------------------------------
| 17 направлений по списку клиента. Полные названия и описания — по материалам клиента.
...
return [
    'items' => [
        ...
        $dir([
            'slug' => 'mfr',
            'num' => '17',
            'title' => 'МФР (миофасциальный релиз)',
            'lead' => 'МФР (миофасциальный релиз) – это мягкая проработка мышц, связок и фасций, поможет вашему телу двигаться свободнее.',
            'img' => 'images/directions/mfr/01.png',
            'gallery' => [
                'images/directions/mfr/02.png',
                'images/directions/mfr/03.png',
            ],
        ]),
